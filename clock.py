...
def timer1():
    ...
    LEDpoints = []
    LEDlib.psize = 4
    LEDlib.createCharColour(canvas1,400-10*((time()-starttime) % 45), 200, charPacmanBlinky,LEDpoints)
    LEDlib.createCharColour(canvas1,10*((time()-starttime) % 45), 200, charDefender,LEDpoints)
...
def timersun():
    ...
    #print(len(canvas1.find_all())) # print number of objects on canvas for debugging
    mainwin.after(1000,timersun)
