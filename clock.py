...
ParadeList = [charScramble3,charScramble2,charScramble,charRobotron4,charRobotron3, charRobotron2,charGalaxian,charJoust,charBubbleBobble,charRobotron,charGalaga, charPacmanBlinky]
...
def timer1():
    global LEDpoints, pathcount, pathparadecount, paradecount
    t = localtime()
    mysec = str0(t.tm_sec)
    mymin = str0(t.tm_min)
    myhour = t.tm_hour
